...
workshops in enhancing the skills of
graduate students, post-docs, and faculty.  We propose to:
...
We will run software-skills workshops for undergraduate students taking part each year in the NSF's Research Experience for Undergraduates (REU)
program, at or near the start of those students' time in the lab.  
The expectation is that this training will help them be more productive 
during their REU (graduate-level participants in our existing workshops typically
...
dependent on computing.  These undergraduates will
...
\end{compactitem}
%
and present papers at the following conferences \comment{These have already been listed above; no need to list them twice. Remove from above?}
\begin{compactitem}
