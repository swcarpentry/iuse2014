...
If we find there are more sites interested in hosting workshops than we are planning to support in a given year, we will select the subset of sites at which we could have the largest impact (those that have weaker native computational science resources) and/or that contribute most to our goal of increasing diversity.
...
For context, Table~\ref{table:schedule} shows a sample schedule from a workshop hosted at Stanford in January 2014 that was focused on Python.
...
11:00 - 11:15 & coffee \\
11:15 - 12:30 & More Scientific computing in Python \\
12:30 - 1:30 & lunch \\
...
\cite{ram2013}).  Software Carpentry has a rich network of trained instructors, often recruited through word-of-mouth or involvement in the open software community, who volunteer as workshop instructors based on workshop location and personal availability.
